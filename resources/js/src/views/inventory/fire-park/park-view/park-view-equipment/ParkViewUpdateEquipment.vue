<template>
  <b-sidebar
    id="update-park-equipment-sidebar"
    :visible="isUpdateParkEquipmentSidebarActive"
    bg-variant="white"
    ...
    right
    @hidden="resetForm"
    @change="(val) => $emit('update:is-update-park-equipment-sidebar-active', val)"
  >
          ...
          <b-row class="mt-1">
            ...
            >
              ...
              >
                ...
                >
                  <b-form-input
                    v-model="parkEquipmentData.qrc_id"
            ...
            >
              ...
              >
                ...
                >
                  <b-form-input
                    v-model="parkEquipmentData.internal_id"
                    class="d-inline-block mr-1"
                  />
            ...
            >
              ...
              >
                ...
                >
                  <b-form-input
                    v-model="parkEquipmentData.serial_number"
                    class="d-inline-block mr-1"
                  />
            ...
            >
              ...
              >
                ...
                >
                  <b-form-rating
                    v-model="parkEquipmentData.equipment_status"
                    variant="warning"
                  />
                  <b-form-invalid-feedback>
                    {{ validationContext.errors[0] }}
          ...
          <b-row class="mt-1">
            ...
            >
              ...
              >
                ...
                >
                  <v-select
                    v-model="parkEquipmentData.equipment_category"
            ...
            >
              ...
              >
                ...
                >
                  <v-select
                    v-model="parkEquipmentData.equipment_model"
                    :dir="$store.state.appConfig.isRTL ? 'rtl' : 'ltr'"
            ...
            >
              ...
              >
                ...
                >
                  <v-select
                    v-model="parkEquipmentData.equipment_weight"
                    :dir="$store.state.appConfig.isRTL ? 'rtl' : 'ltr'"
            ...
            <template
              v-if="parkEquipmentData.equipment_model === 'Water-based' || parkEquipmentData.equipment_model === 'Powder ABC' || parkEquipmentData.equipment_model === 'Foam' || parkEquipmentData.equipment_model === 'Wet chemical' || parkEquipmentData.equipment_model === 'Dry powder'"
            >
              <b-col
                cols="12"
                md="3"
                ...
                >
                  ...
                  >
                    <b-form-radio-group
                      ...
                      v-model="parkEquipmentData.equipment_pressure"
          ...
          <b-row class="mt-1">
            ...
            >
              ...
              >
                ...
                >
                  <v-select
                    v-model="parkEquipmentData.area_id"
                    :dir="$store.state.appConfig.isRTL ? 'rtl' : 'ltr'"
                    :options="areaOptions"
            ...
            >
              ...
              >
                ...
                >
                  <v-select
                    v-model="parkEquipmentData.equipment_fixation"
                    :dir="$store.state.appConfig.isRTL ? 'rtl' : 'ltr'"
              ...
              >
                ...
                >
                  <b-form-radio-group
                    ...
                    v-model="parkEquipmentData.accessories_availability"
          ...
          <b-row class="mt-1">
              ...
              >
                ...
                >
                  <b-form-checkbox-group
                    v-model="parkEquipmentData.standard_sign"
                    :options="signOptions"
                  />
                  <b-form-invalid-feedback>
                    {{ validationContext.errors[0] }}
            ...
            >
              ...
              >
                ...
                >
                  <b-form-checkbox-group
                    v-model="parkEquipmentData.big_sign"
                    :options="signOptions"
                  />
                  <b-form-invalid-feedback>
                    {{ validationContext.errors[0] }}
            ...
            >
              ...
              >
                ...
                >
                  <b-form-checkbox-group
                    v-model="parkEquipmentData.medium_sign"
                    :options="signOptions"
                  />
                  <b-form-invalid-feedback>
                    {{ validationContext.errors[0] }}
            ...
            >
              ...
              >
                ...
                >
                  <b-form-checkbox-group
                    v-model="parkEquipmentData.pictogram"
                    :options="signOptions"
                  />
                  <b-form-invalid-feedback>
                    {{ validationContext.errors[0] }}
            ...
            >
              ...
              >
                ...
                >
                  <b-form-checkbox-group
                    v-model="parkEquipmentData.numbering_s_sign"
                    :options="signOptions"
                  />
                  <b-form-invalid-feedback>
                    {{ validationContext.errors[0] }}
            ...
            >
              ...
              >
                ...
                >
                  <b-form-checkbox-group
                    v-model="parkEquipmentData.numbering_b_sign"
                    :options="signOptions"
                  />
                  <b-form-invalid-feedback>
                    {{ validationContext.errors[0] }}
          ...
          <b-row class="mt-1">
            ...
            >
              ...
              >
                ...
                >
                  <flat-pickr
                    v-model="parkEquipmentData.mfg_date"
                    class="form-control"
            ...
            >
              ...
              >
                ...
                >
                  <flat-pickr
                    v-model="parkEquipmentData.installation_date"
                    class="form-control"
                    :config="{ dateFormat: 'Y-m-d'}"
                    placeholder="YYYY-MM-DD"
                  />
            ...
            >
              ...
              >
                ...
                >
                  <b-form-input
                    v-model="parkEquipmentData.equipment_brand"
                    class="d-inline-block mr-1"
                  />
            ...
            >
              ...
              >
                ...
                >
                  <b-form-input
                    v-model="parkEquipmentData.made_in"
                    class="d-inline-block mr-1"
                  />
            ...
            >
              ...
              >
                ...
                >
                  <b-form-checkbox-group
                    v-model="parkEquipmentData.ce_marking"
                    :options="ceOptions"
                  />
...
export default {
  ...
  model: {
    prop: 'isUpdateParkEquipmentSidebarActive',
    event: 'update:is-update-park-equipment-sidebar-active',
  },
  props: {
  ...
  methods: {
    onSubmit() {
      const data = { ...this.parkEquipmentData }
      const newData = { ...data, ...this.formData }
      this.$emit('submit', newData)
      this.isUpdateParkEquipmentSidebarActive = false
      this.$emit('refetch-equipment-data')
    },
  },
  setup(props) {
    const parkEquipmentData = ref([])
    ...
    // Watch the value of parkEquipmentData.equipment_category
    watch(() => parkEquipmentData.value.equipment_category, category => {
      switch (category) {
    ...
    // Watch the value of parkEquipmentData.equipment_model
    watch(() => parkEquipmentData.value.equipment_model, model => {
      switch (model) {
        case 'Water-based':
          weightOptions.value = [
