<template>
  <b-sidebar
    id="add-new-customer-location-sidebar"
    :visible="isAddNewCustomerLocationSidebarActive"
    bg-variant="white"
    ...
    right
    @hidden="resetForm"
    @change="(val) => $emit('update:is-add-new-customer-location-sidebar-active', val)"
  >
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <v-select
                v-model="customerData.location_description"
          ...
          >
            ...
            >
              <b-form-input
                id="location-contact"
                v-model="customerData.location_phone"
                :state="getValidationState(validationContext)"
                trim
              />
          ...
          >
            ...
            >
              <b-form-input
                id="location-email"
                v-model="customerData.location_email"
                :state="getValidationState(validationContext)"
                trim
              />
          ...
          >
            ...
            >
              <b-form-input
                id="location-address"
                v-model="customerData.location_address"
                :state="getValidationState(validationContext)"
                trim
              />
          ...
          >
            ...
            >
              <b-form-input
                id="postcode"
                v-model="customerData.location_postcode"
                :state="getValidationState(validationContext)"
                trim
              />
              <b-form-invalid-feedback :state="getValidationState(validationContext)">
          ...
          >
            ...
            >
              <v-select
                v-model="customerData.location_city"
                :dir="$store.state.appConfig.isRTL ? 'rtl' : 'ltr'"
                :options="cityOptions"
                :clearable="false"
          ...
          <div>
            {{ customerData.location_coordinator }}
          </div>
          <!-- COORDINATOR -->
          <validation-provider
            #default="validationContext"
          ...
          >
            ...
            >
              <v-select
                v-model="customerData.location_coordinator"
                :dir="$store.state.appConfig.isRTL ? 'rtl' : 'ltr'"
          ...
          >
            ...
            >
              <v-select
                v-model="customerData.location_opening"
                :dir="$store.state.appConfig.isRTL ? 'rtl' : 'ltr'"
...
export default {
  ...
  model: {
    prop: 'isAddNewCustomerLocationSidebarActive',
    event: 'update:is-add-new-customer-location-sidebar-active',
  },
  props: {
  ...
  setup(props, { emit }) {
    ...
    const onSubmit = () => {
      store.dispatch('app-location/addCustomerLocation', { id: router.currentRoute.params.id, customerData: customerData.value })
        .then(() => {
          emit('refetch-data')
          emit('update:is-add-new-customer-location-sidebar-active', false)
        })
    }
  ...
  #add-new-customer-location-sidebar {
    .vs__dropdown-menu {
