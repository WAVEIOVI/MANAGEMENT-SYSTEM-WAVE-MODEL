<template>
  <b-sidebar
    id="update-customer-order-sidebar"
    :visible="isUpdateCustomerOrderSidebarActive"
    bg-variant="white"
    ...
    right
    @hidden="resetForm"
    @change="(val) => $emit('update:is-update-customer-order-sidebar-active', val)"
  >
...
export default {
  ...
  model: {
    prop: 'isUpdateCustomerOrderSidebarActive',
    event: 'update:is-update-customer-order-sidebar-active',
  },
  props: {
  ...
  methods: {
    onSubmit() {
      this.$emit('submit', this.customerOrderData)
      this.isUpdateCustomerOrderSidebarActive = false
      this.$emit('refetch-order-data')
    },
  },
