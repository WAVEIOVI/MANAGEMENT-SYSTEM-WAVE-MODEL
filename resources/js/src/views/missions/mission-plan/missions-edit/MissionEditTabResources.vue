    ...
    >
      ...
      <b-row class="mt-1">
        ...
        >
          ...
          >
            <v-select
              v-model="missionData.team_leader"
        ...
        >
          ...
          >
            <v-select
              v-model="missionData.team_driver"
              :dir="$store.state.appConfig.isRTL ? 'rtl' : 'ltr'"
              :options="team"
              :reduce="(option) => option.technician"
              label="technician"
      ...
      <b-row class="mt-1">
        ...
        >
          ...
          >
            <v-select
              v-model="missionData.vehicle_model"
              :dir="$store.state.appConfig.isRTL ? 'rtl' : 'ltr'"
              :options="vehicle"
      ...
      <b-row class="mt-1">
        ...
        >
          ...
          >
            <b-form-input
              ...
              v-model="missionData.fuel_transportation"
            />
          </b-form-group>
        </b-col>
        <!-- Field: Accommodation -->
        ...
        >
          ...
          >
            <b-form-input
              id="accommodation"
              v-model="missionData.accommodation"
            />
          </b-form-group>
        </b-col>
        <!-- Field: Meals / Food -->
        ...
        >
          ...
          >
            <b-form-input
              id="meals-food"
              v-model="missionData.meals_food"
            />
          </b-form-group>
        </b-col>
      </b-row>
        ...
        >
          ...
          >
            <b-form-input
              ...
              v-model="missionData.pocket_money"
            />
          </b-form-group>
        </b-col>
        <!-- Field: Maintenance / Repair costs -->
        <b-col
          cols="12"
          md="6"
          lg="4"
        >
          ...
          >
            <b-form-input
              ...
              v-model="missionData.repair_costs"
            />
          </b-form-group>
        </b-col>
        <!-- Field: Miscellaneous Expenses -->
        <b-col
          cols="12"
          md="6"
          lg="4"
        >
          ...
          >
            <b-form-input
              ...
              v-model="missionData.miscellaneous_expenses"
            />
          </b-form-group>
        </b-col>
      </b-row>
      <b-row>
        ...
        >
          <b-form-group
            label="Note"
            label-for="mission-finance-note"
          >
            <b-form-textarea
              id="textarea-no-resize"
              v-model="missionData.mission_finance_notes"
              rows="3"
              no-resize
            />
          </b-form-group>
...
export default {
  ...
  computed: {
    formattedTeamMembers: {
      get() {
        try {
          return JSON.parse(this.missionData.team_members)
        } catch (error) {
          return []
        }
      },
      ...
      // Convert the array back to a JSON string and update the original data
        this.missionData.team_members = JSON.stringify(value)
      },
    },
    formattedToolbox: {
      get() {
        try {
          return JSON.parse(this.missionData.resources_toolbox)
        } catch (error) {
          return []
        }
      },
      set(value) {
      // Convert the array back to a JSON string and update the original data
        this.missionData.resources_toolbox = JSON.stringify(value)
      },
    },
    formattedMachine: {
      get() {
        try {
          return JSON.parse(this.missionData.resources_machines)
        } catch (error) {
          return []
        }
      },
      set(value) {
      // Convert the array back to a JSON string and update the original data
        this.missionData.resources_machines = JSON.stringify(value)
      },
    },
  },
  methods: {
