<template>
  ...
  <div>
    ...
    <workshop-list-add-new
      :is-add-new-workshop-sidebar-active.sync="isAddNewWorkshopSidebarActive"
    ...
    <section id="card-style-variation">
      ...
      <b-row class="match-height">
        <!-- Pending Workshop -->
        <b-col
          v-for="(data,index) in pendingWorkshop"
          :key="index"
          cols="12"
          md="6"
          xl="4"
        >
          <b-card
            ...
            @click="() => $router.push({ name: 'missions-workshop-view', params: { id: data.id } })"
          >
            <b-card-body>
        ...
        <b-row>
          ...
          >
            <div class="d-flex align-items-center justify-content-end">
              ...
              <b-button
                variant="primary"
                @click="isAddNewWorkshopSidebarActive = true"
              >
      ...
      >
        ...
        <template #cell(workshop_id)="data">
          <b-media vertical-align="center">
            <b-link
              :to="{ name: 'missions-workshop-view', params: { id: data.item.id } }"
        ...
        <template #cell(location)="data">
          <b-media vertical-align="center">
            ...
            <b-link
              :to="{ name: 'workshops-workshop-plan-view', params: { id: data.item.id } }"
              class="font-weight-bold d-block text-nowrap"
            >
        ...
        <template #cell(workshop_date)="data">
        ...
        <template #cell(workshop_status)="data">
          <b-badge
            pill
            :variant="`light-${resolveWorkshopStatusVariant(data.item.workshop_status)}`"
            class="text-capitalize"
          >
            {{ data.item.workshop_status }}
          </b-badge>
        </template>
        ...
        <template #cell(actions)="data">
          ...
          >
            ...
            <b-dropdown-item :to="{ name: 'workshops-workshop-plan-view', params: { id: data.item.id } }">
              <feather-icon icon="FileTextIcon" />
              <span class="align-middle ml-50">Details</span>
            </b-dropdown-item>

            <b-dropdown-item :to="{ name: 'workshops-workshop-plan-edit', params: { id: data.item.id } }">
              <feather-icon icon="EditIcon" />
              <span class="align-middle ml-50">Edit</span>
            </b-dropdown-item>

            <b-dropdown-item
              @click="removeWorkshop(data.item.id)"
            >
              <feather-icon
                icon="TrashIcon"
...
import useWorkshopsList from './useWorkshopsList'
// import useWorkshopsOptions from '../useWorkshopsOptions'
import workshopStoreModule from '../workshopStoreModule'
import WorkshopListAddNew from './WorkshopListAddNew.vue'
import WorkshopsListFilters from './WorkshopsListFilters.vue'

export default {
  components: {
    WorkshopListAddNew,
    WorkshopsListFilters,
  ...
  data() {
    return {
      solidColor: [
        { bg: 'warning', title: 'Workshop IN230001' },
        { bg: 'warning', title: 'Workshop IN230002' },
        { bg: 'warning', title: 'Workshop IN230003' },
      ],
      mediaData: [
        { avatar: 'CalendarIcon', title: 'Sat, May 25, 2020', subtitle: 'Workshop Date' },
  ...
  setup() {
    ...
    const isAddNewWorkshopSidebarActive = ref(false)
