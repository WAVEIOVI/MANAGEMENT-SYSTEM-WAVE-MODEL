        ...
        >
          ...
          >
            ...
            <b-media-body>
              ...
              <small>{{ workshopData.total_areas_per_park }} </small>
            </b-media-body>
          </b-media>
        </blockquote>
        <blockquote
        ...
        >
          ...
          >
            ...
            <b-media-body>
              ...
              <small>{{ workshopData.total_equipments_per_park }} </small>
            </b-media-body>
          </b-media>
        </blockquote>
      </b-col>
        ...
        >
          ...
          >
            ...
            <b-media-body>
              ...
              <small>{{ workshopData.total_fire_extinguisher_per_park }} </small>
            </b-media-body>
          </b-media>
        </blockquote>
        <blockquote
        ...
        >
          ...
          >
            ...
            <b-media-body>
              ...
              <small>{{ workshopData.total_others_equipments_per_park }} </small>
            </b-media-body>
          </b-media>
        </blockquote>
      </b-col>
...
export default {
  ...
  setup(props) {
    const workshopChartData = ref(props.workshopData)
            ...
            donut: {
              labels: {
                ...
                total: {
                  ...
                  label: 'Total',
                  formatter() {
                    return `${workshopChartData.value.total_equipments_per_park}`
                  },
                },
              },
            },
            ...
            donut: {
              labels: {
                ...
                total: {
                  ...
                  label: 'Total',
                  formatter() {
                    return `${workshopChartData.value.total_fire_extinguisher_per_park}`
                  },
                },
              },
            },
    ...
    categoryChart.value = workshopChartData.value.statistics_categories_count
    ...
    fireExtinguisherChart.value = workshopChartData.value.statistics_fire_extinguisher_count
    ...
    statusChart.value = workshopChartData.value.statistics_status_count
