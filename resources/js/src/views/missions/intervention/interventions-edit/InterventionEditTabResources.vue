<template>
  <div>
    ...
    <!-- Intervention Info: Input Fields -->
    <b-form
    ...
    >
      ...
      <b-row class="mt-1">
        ...
        >
          ...
          >
            <v-select
              v-model="interventionData.team_leader"
        ...
        >
          ...
          >
            <v-select
              v-model="interventionData.team_driver"
              :dir="$store.state.appConfig.isRTL ? 'rtl' : 'ltr'"
              :options="team"
              :reduce="(option) => option.technician"
              label="technician"
      ...
      <b-row class="mt-1">
        ...
        >
          ...
          >
            <v-select
              v-model="interventionData.vehicle_model"
              :dir="$store.state.appConfig.isRTL ? 'rtl' : 'ltr'"
              :options="vehicle"
      ...
      <b-row class="mt-1">
        ...
        >
          ...
          >
            <v-select
              v-model="formattedMachine"
              :dir="$store.state.appConfig.isRTL ? 'rtl' : 'ltr'"
              multiple
              :options="machines"
              :reduce="(option) => option.machine"
              label="machine"
            >
      ...
      <b-row class="mt-1">
        ...
        >
          ...
          >
            <b-form-input
              ...
              v-model="interventionData.fuel_transportation"
            />
          </b-form-group>
        </b-col>
        <!-- Field: Machine -->
        ...
        >
          ...
          >
            <b-form-input
              id="accommodation"
              v-model="interventionData.accommodation"
            />
          </b-form-group>
        </b-col>
        <!-- Field: Machine -->
        ...
        >
          ...
          >
            <b-form-input
              id="meals-food"
              v-model="interventionData.meals_food"
            />
          </b-form-group>
        </b-col>
      </b-row>
        ...
        >
          ...
          >
            <b-form-input
              ...
              v-model="interventionData.pocket_money"
            />
          </b-form-group>
        </b-col>
        <!-- Field: Machine -->
        ...
        >
          ...
          >
            <b-form-input
              ...
              v-model="interventionData.repair_costs"
            />
          </b-form-group>
        </b-col>
        <!-- Field: Machine -->
        ...
        >
          ...
          >
            <b-form-input
              ...
              v-model="interventionData.miscellaneous_expenses"
            />
          </b-form-group>
        </b-col>
      </b-row>
      <b-row>
        ...
        >
          <b-form-group
            label="Note"
            label-for="intervention-finance-note"
          >
            <b-form-textarea
              id="textarea-no-resize"
              v-model="interventionData.intervention_finance_notes"
              rows="3"
              no-resize
            />
          </b-form-group>
...
export default {
  ...
  computed: {
    formattedTeamMembers: {
      get() {
        try {
          return JSON.parse(this.interventionData.team_members)
        } catch (error) {
          return []
        }
      },
      ...
      // Convert the array back to a JSON string and update the original data
        this.interventionData.team_members = JSON.stringify(value)
      },
    },
    formattedToolbox: {
      get() {
        try {
          return JSON.parse(this.interventionData.resources_toolbox)
        } catch (error) {
          return []
        }
      },
      set(value) {
      // Convert the array back to a JSON string and update the original data
        this.interventionData.resources_toolbox = JSON.stringify(value)
      },
    },
    formattedMachine: {
      get() {
        try {
          return JSON.parse(this.interventionData.resources_machines)
        } catch (error) {
          return []
        }
      },
      set(value) {
      // Convert the array back to a JSON string and update the original data
        this.interventionData.resources_machines = JSON.stringify(value)
      },
    },
  },
  methods: {
    onSubmit() {
      this.$emit('submit', this.interventionData)
    },
  },
  setup() {
    const team = [
