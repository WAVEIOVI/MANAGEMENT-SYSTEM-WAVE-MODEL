        ...
        >
          ...
          >
            ...
            <b-media-body>
              ...
              <small>{{ interventionData.total_areas_per_park }} </small>
            </b-media-body>
          </b-media>
        </blockquote>
        <blockquote
        ...
        >
          ...
          >
            ...
            <b-media-body>
              ...
              <small>{{ interventionData.total_equipments_per_park }} </small>
            </b-media-body>
          </b-media>
        </blockquote>
      </b-col>
        ...
        >
          ...
          >
            ...
            <b-media-body>
              ...
              <small>{{ interventionData.total_fire_extinguisher_per_park }} </small>
            </b-media-body>
          </b-media>
        </blockquote>
        <blockquote
        ...
        >
          ...
          >
            ...
            <b-media-body>
              ...
              <small>{{ interventionData.total_others_equipments_per_park }} </small>
            </b-media-body>
          </b-media>
        </blockquote>
      </b-col>
...
export default {
  ...
  setup(props) {
    const interventionChartData = ref(props.interventionData)
            ...
            donut: {
              labels: {
                ...
                total: {
                  ...
                  label: 'Total',
                  formatter() {
                    return `${interventionChartData.value.total_equipments_per_park}`
                  },
                },
              },
            },
            ...
            donut: {
              labels: {
                ...
                total: {
                  ...
                  label: 'Total',
                  formatter() {
                    return `${interventionChartData.value.total_fire_extinguisher_per_park}`
                  },
                },
              },
            },
    ...
    categoryChart.value = interventionChartData.value.statistics_categories_count
    ...
    fireExtinguisherChart.value = interventionChartData.value.statistics_fire_extinguisher_count
    ...
    statusChart.value = interventionChartData.value.statistics_status_count
